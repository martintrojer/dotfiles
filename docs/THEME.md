...
| Foot (Linux) | `foot/.config/foot/foot.ini` | Catppuccin Mocha hex values inlined under `[colors-dark]` |
| Ghostty (macOS) | `ghostty/.config/ghostty/config` | Catppuccin Mocha named theme |
