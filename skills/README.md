...
| `verification-before-completion` | [obra/superpowers](https://github.com/obra/superpowers) (MIT) @ `44c9b2d` | Local pstack @ `60c641e` backport: name and prove the safety invariant for risky indirect changes, or label it unproven. Plus two backports (2026-09): *Could the Check Have Failed?* — self-built oracles, the run that disagreed, tuned conditions, proxy evidence, read-only verification — and *A Refusal Is a Result* |
