...
- **`tmux-fingers`:** hint-overlay copy-mode (think vimium for tmux panes). Implementation is hundreds of lines of Ruby + shell. Not feasible to rewrite, not worth vendoring (would just freeze upstream and miss bug fixes).
